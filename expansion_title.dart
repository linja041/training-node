...
//                  ))),
          ...
          GestureDetector(
              ...
              child: Container(
                  decoration: BoxDecoration(
                    color: !_isExpanded ? widget.headerBackgroundColorStart : widget.headerBackgroundColorEnd ?? widget.headerBackgroundColorStart,
                    borderRadius: !_isExpanded ? new BorderRadius.circular(5.0) : new BorderRadius.vertical(bottom: Radius.circular(5.0)),
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: closed
          ...
          : Container(
          decoration: BoxDecoration(
            borderRadius: !_isExpanded ? new BorderRadius.circular(5.0) : new BorderRadius.vertical(top: Radius.circular(5.0)),
